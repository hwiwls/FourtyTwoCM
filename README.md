...
[42CM 개발 및 학습일지(Click.ᐟ)](https://velog.io/@hwyjj/42CM-%ED%94%84%EB%A0%88%EC%9E%84%EC%9B%8C%ED%81%AC-%EC%95%84%ED%82%A4%ED%85%8D%EC%B2%98-%EB%B0%8F-%EA%B8%B0%EC%88%A0%EC%8A%A4%ED%83%9D-%EC%84%A0%ED%83%9D-%EA%B3%BC%EC%A0%95)
...
저는 `ViewController`가 `ViewModel`을 직접 생성하여 사용했습니다. 이로 인해 실제 네트워크 호출을 피하고 모의 객체를 사용하고자 할 때 문제가 발생했습니다.
...
의존성 주입을 도입하면 클래스들이 필요한 의존성을 외부에서 주입받도록 설계하면, 테스트 시 모의 객체를 쉽게 사용할 수 있습니다. `ViewController`가 `ViewModel`을 외부에서 주입받도록 하면, 유닛 테스트에서 다양한 시나리오를 테스트할 수 있게 됩니다.<br/>
